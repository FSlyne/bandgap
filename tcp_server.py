...
class testmode(object):
   ...
   @threaded
   def worker(self):
      global remoteaddress, redirect
      while True:
         remoteaddress=(self.updest,self.port); redirect=False
         time.sleep(self.uptime)
         remoteaddress=(self.downdest,self.port); redirect=True
